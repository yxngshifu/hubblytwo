...
import discover from '/Users/shifu/hubblytwo/src/Assets/discover.png';
import Vector from '/Users/shifu/hubblytwo/src/Assets/Vector.png';
      ...
      <div className='w-full relative font-MuseoModerno bg-[#048392]' style={VectorStyle}>
        <div className='flex items-center justify-center'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-0 flex-col text-white'>
            <div>
              <div className="px-4 lg:px-10 xl:px-20 md:px-10 lg:px-40 xl:px-60 text-justify py-4 md:py-10 lg:py-20">
