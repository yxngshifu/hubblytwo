  ...
  return (
    <div className='w-full text-center relative font-MuseoModerno bg-[#e0f7f9]'>
      <div className="mx-auto flex flex-col items-center px-20 md:px-40 lg:px-60 ">
        <p className=' text-[#048392] text-sm font-Raleway font-bold py-4'>WHERE YOU ARE</p>
        ...
        <img className=" lg:w-[400px]   md:w-[300px] w-[200px]" src={communicate1} alt="Communication" />
      </div>
    </div>
  );
}
