  ...
  return (
    <div className='w-full text-center px-20 md:px-40 lg:px-20 xl:px-40 relative font-MuseoModerno bg-[#e0f7f9] py-8'>
      <div className="mx-auto flex flex-col items-center">
        <p className='text-[#048392] text-sm font-Raleway font-bold'>OUR COMMITMENT TO SUSTAINABILITY</p>
        <h1 className='font-bold text-3xl md:text-2xl text-black'>Goals We Support</h1>
        <p className='md:px-10 lg:px-40 text-justify text-md md:text-lg  lg:text-xl xl:text-2xl text-[#494D4D] font-Raleway font-medium'>
