  ...
  return (
    ...
    <div className='w-full relative font-MuseoModerno ' >
      ...
      <div className=' grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-4  flex-col text-black'>
          ...
          <div className=" px-16 md:px-40  py-24 md:py-40 lg:px-60 text-justify ">
        ...
        <p className='mb-4 text-md md:text-lg  lg:text-xl xl:text-2xl text-[#494D4D] font-Raleway font-medium'>Eco-friendly solutions at Your fingertips  </p>
         ...
         <div className='w-full relative font-MuseoModerno  py-20' style={ellipseStyle}>
          <div>
