      ...
      <div className='py-8 md:py-8 px-4 lg:px-20 text-center items-center'>
        <div className='max-w-screen-lg mx-auto'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-8'>
            <div className='text-black text-md md:text-lg lg:py-12 md:px-40 lg:px-20 lg:text-xl xl:text-2xl'>
              <p className='text-[#048392] text-sm mb-2'>TRUSTED PROFESSIONALS</p>
